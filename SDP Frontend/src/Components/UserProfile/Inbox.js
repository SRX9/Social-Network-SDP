                        ...
                        <div className=" bg-light br p-3">
                            <Tabs tabPosition="left" >
                                <TabPane  tab="Fan-Mails" key="2">
                                    <div style={{ height: "700px", overflowX: "hidden", overflowY: "scroll" }}>
                                        {this.state.inbox.map(obj => {
                                            if (obj.type === 2) {
                                                return <Row className="m-2 bg-white border br">
                                                    <div className="pr-3  pl-3 pt-3 text-left">
                                                        <Link to={"/profile/" + obj.by}>
                                                            ...
                                                            <span style={{ fontWeight: "500", fontSize: "1.2rem" }}
                                                                ...
                                                                {"@" + obj.by} {obj.verfied ? <span
                                                                    style={{
                                                                        fontSize: "1rem",
                                                                        fontWeight: "900"
                                                                    }}
                                                                ><Icon type="check-circle" theme="filled" /></span> : null}
                                                            </span>
                                                        </Link>
                                                        
                                                        <span className="d-inline-break float-right pr-3">
                                                             {obj.time}
                                                        </span>
                                                    </div>
                                                    <div className=" text-break text-left"
                                                        style={{ marginTop: "-20px", paddingLeft: "100px", fontWeight: "500", fontSize: "1rem" }}>
                                ...
                                <TabPane tab="Notifications" key="1">
                                    <div style={{ height: "700px", overflowX: "hidden", overflowY: "scroll" }}>
                                        {this.state.inbox.map(obj => {
                                            if (obj.type === 1) {
                                                return <Row className="m-2 bg-white text-center mr-4 mt-3   border br">
                                                    <p className=" float-right p-3 pr-4"> {obj.time}</p>

                                                    <div className="m-4 text-break "
                                ...
                                <TabPane  tab="Forwards | Tags" key="3">
                                    <div style={{ height: "700px", overflowX: "hidden", overflowY: "scroll" }}>
                                        {this.state.inbox.map(obj => {
                                            if (obj.type === 4) {
                                                return <Row className="m-2 border mt-3 mr-4 bg-white  br">
                                                    <div className=" float-right p-3 pr-4"> {obj.time}</div>
                                                    <div className="pr-3 pl-3 pt-3 text-left">
                                                        <Link to={"/profile/" + obj.by}>
                                                            <div>
                                                                <span className="d-inline">
                                                    ...
                                                    <div className="text-left pb-3" style={{
                                                        fontSize: "1.1rem",
                                                        fontWeight: "500",
                                                        paddingLeft:"102px",
                                                        marginTop:"-25px"
                                                    ...
                                                    <div className="pb-3 text-break text-left"
                                                        style={{ paddingLeft: "95px", fontWeight: "500", fontSize: "1rem" }}>
                                                        {obj.post.type !== 4 ? <div>
                                                            <Link to={"/posts/" + obj.post.postid}>
                                                                <div
                                                                    className="thumbnail1  text-left cur con  faded">
                                                                    <img style={{ marginLeft: "-37px" }} src={obj.post.photo} className="faded" alt="Image" />
                                                                    <div
                                                                        class="text-block11 glass p-2 pr-3"
                                                                        style={{ Radius: "0px 15px 15px 0px" }}
                                                                    >
                                                                        <div className="d-inline-block br pr-4 ">
                                                                            <h6 className="text-white">
                                                                                {this.numberToWord(obj.post.streams)}
                                                                            </h6>
                                                                            <p style={{ fontSize: "1rem" }}>Streams</p>
                                                                        </div>
                                                                        <div className="d-inline-block ">
                                                                            <h6 className="text-white">
                                                                                {this.numberToWord(obj.post.reactionsNo)}
                                                                            </h6>
                                                                ...
                                                                <Link to={"/posts/" + obj.post.postid}>
                                                                    <div className="p-3">{this.tagColor(obj.post.text)}</div>

                                                                    <div
                                                                        className="thumbnail1  text-left cur con  faded">                                                                        <div
                                                                            class="text-block11 glass p-2 pr-3"
                                                                            style={{ Radius: "0px 15px 15px 0px" }}
                                                                        >
                                                                            <div className="d-inline-block br pr-4 ">
                                                ...
                                                return <Row className="m-2 mr-4 mt-3    border bg-white  br">
                                                    <div className=" float-right p-3 pr-4"> {obj.time}</div>
                                                    <div className="pr-3 pl-3 pt-3 text-left">
                                                        <Link to={"/profile/" + obj.by}>
                                                            <div>
                                                                ...
                                                                <span style={{ fontWeight: "500", fontSize: "1.2rem" }}
                                                                    ...
                                                                    ><Icon type="check-circle" theme="filled" /> <span style={{ fontWeight: "500" }}>tagged you in this post.</span></span> : null}
                                                                </span>
                                                            </div>
                                                        </Link>
                                                    </div>
                                                    <div className="pb-3 text-break text-left"
                                                        ...
                                                        {obj.post.type !== 1 ? <div>
                                                            <Link to={"/posts/" + obj.post.postid}>
                                                                <div
                                                                    className="thumbnail1  text-left cur con  faded">
                                                                    <img src={obj.post.photo} className="faded" alt="Image" />
                                                                    <div
                                                                        class="text-block11 glass p-2 pr-3"
                                                                        style={{ Radius: "0px 15px 15px 0px" }}
                                                                    >
